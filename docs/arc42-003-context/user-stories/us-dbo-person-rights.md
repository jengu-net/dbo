...
| `REQ-DBO-PDI-PSEUDONYM-RESOLVED-BY-SCAN` | Which person a pseudonym belongs to is answered by deriving over the people whose keys could have made it, never by a stored mapping; the question states its scope and its purpose and is recorded as the disclosure it is, and the record names the person rather than the pseudonym. A person whose key is destroyed is not found, and is not distinguishable from one who was never here. | PROVEN |
