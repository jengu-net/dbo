...
| [Sealed work](sealed-work.md) | decided; trail, keys, seal and chain built; router forward and stream open | [#166](https://github.com/jengu-net/dbo/issues/166), [#172](https://github.com/jengu-net/dbo/issues/172)–[#180](https://github.com/jengu-net/dbo/issues/180) |
