**Not scheduled. Analysis only: no profiled surface is served and no issue is filed.**
...
(blob storage), [where a neutral store earns its keep](../016-where-a-neutral-store-earns-its-keep/README.md).
