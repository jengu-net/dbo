...
| [024 Definitions out of the heap](024-definitions-out-of-the-heap/README.md) | Open. A second face costs 444 MB on top of 225 for the first, and the aim is a serving process holding neither graph. Four of the nine moves on the critical path are done, two of them closed by reading rather than by work; what is left of the serving reaches is `_include`, which item 021 is deciding. No megabyte moves until the ninth. |
