...
| [021 The platform's own entities cannot be asked about](021-the-platforms-own-entities/README.md) | Open. Runs, the trail and the declarations have a rich write surface and almost no way to ask about them, so a product reaches for the general FHIR door instead. Carries the guide's chapter list. |
