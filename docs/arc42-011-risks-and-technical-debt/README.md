...
| [003 Own-world tests move down the ladder](003-tests-move-down-the-ladder/README.md) | Open. The worklist is empty, but one runtime holding every class's tenants is slower than the worlds it replaced. Next: a cast named for the parts tenants play. |
