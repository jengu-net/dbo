...
| [004 The guide runs three times in CI](004-the-guide-runs-three-times/README.md) | Open. Who moves the pin is now written down. Next: port the one step the shell harness still covers, which is what lets the third run go. |
