...
| Item | State |
|---|---|
| [001 The documentation tree is moved to match its map](001-documentation-shape/README.md) | Open. Next: fold `docs/tasks/` and `docs/plans/` into this chapter and retire the implementation status page. |
