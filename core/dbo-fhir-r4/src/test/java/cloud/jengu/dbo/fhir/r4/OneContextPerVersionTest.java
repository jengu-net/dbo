...
class OneContextPerVersionTest {
    ...
    private static R4Personality personalityFor(String system) {
    ...
    void aSecondPersonalityForOneTenantSharesIt() {
        ...
        R4Personality serving = personalityFor("urn:same");
        R4Personality maintenance = personalityFor("urn:same");
