...
public enum DboFeatures implements Feature {
    ...
    TEN_MIGRATED("tenancy & isolation — migrated whole from hand-written prose; each promise below carries its own proof status.",
            List.of(DboPromises.TEN_APPLYING_IS_ASKED_FOR_AND_RECORDED, DboPromises.TEN_A_CHANGE_IS_NOT_A_RETRACTION, DboPromises.TEN_A_REDECLARATION_IS_NOTICED, DboPromises.TEN_DECLARED_TOGETHER_COME_UP_TOGETHER, DboPromises.TEN_A_DECLARATION_IS_A_RECORD, DboPromises.TEN_SERVED_FROM_WHAT_WAS_APPLIED, DboPromises.TEN_STRUCTURAL_SCOPING, DboPromises.TEN_DEDICATED_DATABASE_TIER, DboPromises.TEN_CREDENTIAL_BLIND_PROVISIONING, DboPromises.TEN_REGISTRY_SCOPED_ACCESS, DboPromises.TEN_ERASURE_BY_DROP, DboPromises.TEN_SHARED_TIER_ISOLATION, DboPromises.TEN_FAIRNESS_QUOTAS)),
