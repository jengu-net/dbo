...
/**
 * What the index face costs a serving tenant, and whether it stops a context
 * being built at all.
 *
...
class WhatTheIndexFaceCostsIT {

    private static final String DIAL = "dbo.payloads.index";
    private static final String TENANT = "indeksihind";
    private static final String PREFIX = "http://hl7.org/fhir/StructureDefinition/";
    private static final Path REPORT = Path.of("build", "index-face-cost.txt");
    ...
    void up() throws Exception {
        ...
        provisioner = new LocalDatabasePerTenantProvisioner(
                SharedPostgres.urlFor("WhatTheIndexFaceCostsIT"),
    ...
    @Test
    @DisplayName("what a tenant on the index face holds, what the index itself costs, and how "
            + "many worker contexts were built to get there")
    void whatTheIndexFaceCosts() throws Exception {
        ...
        String said = """
                === what the index face costs, r4, one face root ===
                empty runtime                      %d MB
