// The R4 personality bundle: full HAPI R4 stack (structures + validation)
    ...
    doFirst {
        ...
        manifest {
            attributes(
                ...
                "Bundle-SymbolicName" to "io.dbo.spike.personality.r4",
                "Bundle-Version" to "0.0.1",
                "Bundle-Activator" to "io.dbo.spike.r4.Activator",
